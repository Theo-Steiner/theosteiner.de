...
>
	...
	<ul class="ml-[-0.60rem] flex">
		...
		<li class="flex items-center">
			<a
				class="hidden rounded-lg p-1 font-semibold text-gray-900 transition-all hover:bg-yellow-200/50 dark:text-yellow-400 sm:px-3 sm:py-2 md:inline-block"
				rel="external"
				href={'/rss.xml'}
	...
	<div class="flex items-center space-x-4">
		<a
			class="rounded-lg text-gray-900 hover:bg-yellow-200/50 dark:text-yellow-400"
		...
		<button
			...
			class="hover:ring-200 ml-1 flex h-9 w-9 items-center justify-center rounded-lg bg-gray-900 ring-yellow-400
			transition-all dark:bg-yellow-400"
		...
		>
			...
			{:else}
				<svg
					...
					fill="none"
					stroke="currentColor"
					class="h-5 w-5 text-yellow-400 dark:text-gray-200"
				>
					<path
						stroke-linecap="round"
						stroke-linejoin="round"
